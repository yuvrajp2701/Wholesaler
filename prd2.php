...
<html lang="en">
  ...
  <!-- TODo: 22:20 -->
    ...
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="images/category-2.jpg" width="100%" id="ProductImg" />
        ...
        <div class="col-2">
          ...
          <h3>Small Purse for Women</h3>
          <a href="./cart.php" class="btn">Add to Cart</a>
          <a href="./order.php" class="btn">Cash on Delivary</a>
          <h3>Product Details<i class="fa fa-indent"></i></h3>
          <br />
          <p>INOVERA Faux Leather Women Handbags Shoulder Hobo Bag Purse With Long Strap, 32L x 13B x 30H cm
          </p>
        </div>
      </div>
    </div>
